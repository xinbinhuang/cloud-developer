...
- [Serverless](#serverless)
  ...
  - [Lambda](#lambda)
    ...
    - [Invocation types & Error handling](#invocation-types--error-handling)
...
![web-architect](img/lambda-web-architect.jpg)
...
> [Labmda Error Handling Link](https://docs.aws.amazon.com/lambda/latest/dg/with-kinesis.html#services-kinesis-errors)

![error-handling](./img/error-handling.jpg)
...
> [Demo Code](../course-04/exercises/c4-demos-master/04-chaos-monkey/index.js)

![chaos-monkey](./img/chaos-monkey.jpg)
...
- Lambda
- [API Gateway](https://docs.aws.amazon.com/apigateway/latest/developerguide/api-gateway-method-request-validation.html)

> In the example code for this project, it is using the `serverless-reqvalidator-plugin`, and the code is a bit convoluted. Luckily, request validation is now [natively supported](https://www.serverless.com/framework/docs/providers/aws/events/apigateway/#request-schema-validators) by Serverless framework.
...
![integration](./img/integration-modes.jpg)
